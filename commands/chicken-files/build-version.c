...
lf[3]=C_decode_literal(C_heaptop,"\376B\000\000\007ce980c4");
lf[4]=C_h_intern(&lf[4],16,"\003sysbuild-branch");
lf[5]=C_h_intern(&lf[5],17,"\003sysbuild-version");
lf[6]=C_decode_literal(C_heaptop,"\376B\000\000\0064.11.0");
...
if(!C_demand(C_calculate_demand(3,c,3))){C_save_and_reclaim((void *)f_213,2,av);}
a=C_alloc(3);
/* ##sys#peek-c-string */
t2=*((C_word*)lf[1]+1);{
C_word *av2;
